export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxe0360639822f72ca",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "7f677d43f92fb398d57d4b57710bfdad",
   ...
   */
  USERS: [oV8nd6kUvGxs4fyFx391ixrckG0o,oV8nd6iirLh9aKFFgy-XIa0SNEv
    {
      // 想要发送的人的名字
      name: "老婆0",
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplated: "KUG2UmpxVbfB5oHlRAuUGpWzw2Ab2VjWb1UKEvxzIos",
      // 所在省份
      province: "青海",
      // 所在城市
      city: "西宁",
